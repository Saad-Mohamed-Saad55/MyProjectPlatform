...
const ChartDisplay = ({ chartConfigs, data }) => {
    return (
        <div style={{ display: 'flex',flexDirection:"column", alignItems:'stretch',paddingInline:'5rem',width:'fit-content', gap: '30px' }}>
            {chartConfigs.map((config, index) => {
                ...
                if (config.chartType.value === 'pie') {
                    ...
                    return (
                        <>
                        <div key={index} style={{ flex: '1 1 300px',display:'flex', alignItems:"center" , justifyContent:'center',minWidth: '300px', border: '1px solid #ccc', padding: '10px', borderRadius: '5px' }}>
